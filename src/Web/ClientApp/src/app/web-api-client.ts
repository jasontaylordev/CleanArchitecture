...
export class Test1Client implements ITest1Client {
    ...
    getSuma(): Observable<number> {
        let url_ = this.baseUrl + "/api/Test1";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetSuma(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSuma(response_ as any);
                } catch (e) {
    ...
    protected processGetSuma(response: HttpResponseBase): Observable<number> {
