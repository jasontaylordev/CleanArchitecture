...
export interface IProductsEndpointsClient {
...
export class ProductsEndpointsClient implements IProductsEndpointsClient {
    ...
    getProducts(): Observable<void> {
        let url_ = this.baseUrl + "/api/ProductsEndpoints";
        url_ = url_.replace(/[?&]$/, "");
