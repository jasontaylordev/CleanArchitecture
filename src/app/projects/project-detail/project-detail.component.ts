...
export class ProjectDetailComponent implements OnInit, OnDestroy {
  ...
  createItem(): void {
    ...
    const command = new CreateProjectTodoItemCommand({
      projectId: this.projectId,
      title,
      description: this.newItem.description || undefined,
      dueDate: this.toDate(this.newItem.dueDate),
  ...
  editItem(item: ProjectTodoItemDto): void {
    ...
    this.editingItemDueDate = this.toDateInputValue(item.dueDate);
  }
  ...
  updateItem(): void {
    ...
    const command = new UpdateProjectTodoItemCommand({
      id: this.editingItem.id,
      projectId: this.projectId,
      title: this.editingItem.title,
      description: this.editingItem.description,
      dueDate: this.toDate(this.editingItemDueDate)
    });
